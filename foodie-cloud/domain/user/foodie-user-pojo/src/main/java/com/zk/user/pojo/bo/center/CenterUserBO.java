package com.zk.user.pojo.bo.center;
...
public class CenterUserBO {
    ...
    @ApiModelProperty(value = "用户昵称", name = "nickname", example = "jack", required = true)
    private String nickname;

    @Length(max = 12, message = "用户真实姓名不能超过12位")
    @ApiModelProperty(value = "真实姓名", name = "realname", example = "jack", required = true)
    ...
    @Email
    @ApiModelProperty(value = "邮箱地址", name = "email", example = "123123@qq.com", required = true)
    ...
    @ApiModelProperty(value = "生日", name = "birthday", example = "1900-01-01", required = true)
